  ...
  return (
    <div className="App p-4 lg:p-7 ">
      <div className="flex flex-col items-center ">
        ...
        <p data-aos="fade-up" data-aos-delay="350" className="text-3xl lg:text-4xl dark:text-neutral-200 text-center">Book a Quick Call With Us?</p>
